...
<html lang="fr" >
  ...
  <body>
    ...
    <div class="noimprim">
    <ul class="menu">';
  if ($_SERVER['PHP_SELF'] == "/voeux/bilan-seconde.php")
      {echo '
  ...
  if ($_SERVER['PHP_SELF'] == "/voeux/bilan-premiere.php")
      {echo '
  ...
  if (!in_array($_SESSION['login'],array('admin','dormoy','direction'))){
    if ($_SERVER['PHP_SELF'] == "/voeux/classe.php")
      {echo '
    ...
    if ($_SERVER['PHP_SELF'] == "/voeux/admin.php")
      {echo '
    ...
    if ($_SERVER['PHP_SELF'] == "/voeux/gestion_prof.php")
      {echo '
  ...
  if (in_array($_SESSION['login'],array('admin','direction'))){
    if ($_SERVER['PHP_SELF'] == "/voeux/creation_groupe.php")
      {echo '
