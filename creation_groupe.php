...
<table class="bilan">
  <form method="post" action="creation_groupe.php">
    ...
    <tr>
      <th></th>
      <th class="bilan">Hist.-Géo</th>
      <th class="bilan">Litt. et Philo</th>
...
elseif (isset($_SESSION['nom'])){
  include 'menu.php';
  echo '<h1>Vous n\'avez pas accès à cette page. Vous venez de briser notre CONFIANCE. Un message a été envoyé à M. BLANQUER.</h1>';}
